...
--
-- Host: localhost    Database: larashop1
-- ------------------------------------------------------
...
INSERT INTO `admin_menu` VALUES (1,0,1,'首页','fa-bar-chart','/',NULL,NULL,'2020-03-31 05:17:43'),(2,0,6,'系统管理','fa-tasks',NULL,NULL,NULL,'2020-04-03 13:20:29'),(3,2,7,'用户','fa-users','auth/users',NULL,NULL,'2020-04-03 13:20:29'),(4,2,8,'角色','fa-user','auth/roles',NULL,NULL,'2020-04-03 13:20:29'),(5,2,9,'权限','fa-ban','auth/permissions',NULL,NULL,'2020-04-03 13:20:29'),(6,2,10,'菜单','fa-bars','auth/menu',NULL,NULL,'2020-04-03 13:20:29'),(7,2,11,'操作日志','fa-history','auth/logs',NULL,NULL,'2020-04-03 13:20:29'),(8,0,2,'用户管理','fa-users','/users',NULL,'2020-03-31 05:37:23','2020-03-31 05:37:57'),(9,0,3,'商品管理','fa-cubes','/products',NULL,'2020-03-31 06:32:58','2020-03-31 06:33:09'),(10,0,4,'订单管理','fa-rmb','/orders',NULL,'2020-04-03 02:54:43','2020-04-03 02:54:55'),(11,0,5,'优惠券管理','fa-tags','/coupon_codes',NULL,'2020-04-03 13:20:23','2020-04-03 13:55:29');
...
-- Dump completed on 2020-04-04 21:48:08
